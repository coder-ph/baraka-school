  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50">
        {/* Sticky Navbar with Blue Line */}
        <div className="sticky top-0 bg-white z-50">
          <Navbar />
          <div className="border-b-2 border-blue-600"></div>
        </div>

        <div className="pr-4 pl-4 lg:pr-55 lg:pl-55 py-5">
          <div className="container mx-auto max-w-6xl"> 
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-30">
              {/* Left Column - Sidebar */}
              ...
              <div className="lg:col-span-3 lg:pt-20 lg:pl-15">
                {/* Carousel Card */}
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-6 lg:p-8">
                    ...
                    <div className="bg-yellow-50 rounded-lg p-6 border-l-4 border-yellow-500 mt-4">
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-4">
                        <div className="text-3xl font-bold text-yellow-600 mb-2 lg:mb-0">90%</div>
